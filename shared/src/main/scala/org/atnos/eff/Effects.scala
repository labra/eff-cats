...
object EffectsToFx extends LowerEffectsToFx1 {
  ...
  implicit def one[H[_]]: EffectsToFx.Aux[H |: NoEffect, In1[H]] =
    new EffectsToFx[H |: NoEffect] {
      type X = In1[H]

      def toEffects[V](u: Union[In1[H], V]): Union[H |: NoEffect, V] =
        u.asInstanceOf[Union[H |: NoEffect, V]]

      def toFx[V](u: Union[H |: NoEffect, V]): Union[In1[H], V] =
        u.asInstanceOf[Union[In1[H], V]]
    }
...
trait LowerEffectsToFx1 extends LowerEffectsToFx2 {
  ...
  implicit def two[H1[_], H2[_]]: EffectsToFx.Aux[H1 |: H2 |: NoEffect, In2[H1, H2]] =
    new EffectsToFx[H1 |: H2 |: NoEffect] {
      type X = In2[H1, H2]

      def toEffects[V](u: Union[In2[H1, H2], V]): Union[H1 |: H2 |: NoEffect, V] =
        u.asInstanceOf[Union[H1 |: H2 |: NoEffect, V]]

      def toFx[V](u: Union[H1 |: H2 |: NoEffect, V]): Union[In2[H1, H2], V] =
        u.asInstanceOf[Union[In2[H1, H2], V]]
    }
}
...
trait LowerEffectsToFx2 extends LowerEffectsToFx3 {
  ...
  /** two effects in a list can be transformed to a tree of effects */
  implicit def twos[H1[_], H2[_]]: EffectsToFx.Aux[H1 |:: H2, In2[H1, H2]] =
    new EffectsToFx[H1 |:: H2] {
      type X = In2[H1, H2]

      def toEffects[V](u: Union[In2[H1, H2], V]): Union[H1 |:: H2, V] =
        u.asInstanceOf[Union[H1 |:: H2, V]]

      def toFx[V](u: Union[H1 |:: H2, V]): Union[In2[H1, H2], V] =
        u.asInstanceOf[Union[In2[H1, H2], V]]
    }
...
trait LowerEffectsToFx3 extends LowerEffectsToFx4 {
  ...
  implicit def three[H1[_], H2[_], H3[_]]: EffectsToFx.Aux[H1 |: H2 |: H3 |: NoEffect, In3[H1, H2, H3]] =
    new EffectsToFx[H1 |: H2 |: H3 |: NoEffect] {
      type X = In3[H1, H2, H3]

      def toEffects[V](u: Union[In3[H1, H2, H3], V]): Union[H1 |: H2 |: H3 |: NoEffect, V] =
        u.asInstanceOf[Union[H1 |: H2 |: H3 |: NoEffect, V]]

      def toFx[V](u: Union[H1 |: H2 |: H3 |: NoEffect, V]): Union[In3[H1, H2, H3], V] =
        u.asInstanceOf[Union[In3[H1, H2, H3], V]]
    }
}
...
object FxToEffects extends LowerFxToEffects1 {
  ...
  implicit def one[H[_]]: FxToEffects.Aux[In1[H], H |: NoEffect] =
    new FxToEffects[In1[H]] {
      type X = H |: NoEffect
...
trait LowerFxToEffects1 extends LowerFxToEffects2 {
  ...
  /** two effects in a list can be transformed to a tree of effects */
  implicit def two[H1[_], H2[_]]: FxToEffects.Aux[In2[H1, H2], H1 |: H2 |: NoEffect] =
    new FxToEffects[In2[H1, H2]] {
...
trait LowerFxToEffects2 extends LowerFxToEffects3 {
  ...
  /** two effects in a list can be transformed to a tree of effects */
  implicit def twos[H1[_], H2[_]]: FxToEffects.Aux[In2[H1, H2], H1 |:: H2] =
    new FxToEffects[In2[H1, H2]] {
      type X = H1 |:: H2
...
trait LowerFxToEffects3 extends LowerFxToEffects4 {
  /** three effects in a list can be transformed to a tree of effects */
  implicit def three[H1[_], H2[_], H3[_]]: FxToEffects.Aux[In3[H1, H2, H3], H1 |: H2 |: H3 |: NoEffect] =
    new FxToEffects[In3[H1, H2, H3]] {
