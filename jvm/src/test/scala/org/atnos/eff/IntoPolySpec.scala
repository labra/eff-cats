...
"""
  ...
  def into1 =
    Eff.send[Option1, In1[Option1], Int](Option1(1)).into[In1[Option1]].runOpt.run === 1

  def into2 = {
    Eff.send[Option1, In1[Option1], Int](Option1(1)).map(identity _).into[In2[Option1, Option2]].runOpt.runOpt.run === 1
    Eff.send[Option2, In1[Option2], Int](Option2(1)).map(identity _).into[In2[Option1, Option2]].runOpt.runOpt.run === 1
  }

  def more = {
    Eff.send[Option1, In2[Option2, Option1], Int](Option1(1)).map(identity _).into[In2[Option1, Option2]].runOpt.runOpt.run === 1

    Eff.send[Option1, In1[Option1], Int](Option1(1)).map(identity _).into[In3[Option1, Option2, Option3]].runOpt.runOpt.runOpt.run === 1
    Eff.send[Option2, In1[Option2], Int](Option2(1)).map(identity _).into[In3[Option1, Option2, Option3]].runOpt.runOpt.runOpt.run === 1
    Eff.send[Option3, In1[Option3], Int](Option3(1)).map(identity _).into[In3[Option1, Option2, Option3]].runOpt.runOpt.runOpt.run === 1

    Eff.send[Option1, In2[Option1, Option2], Int](Option1(1)).map(identity _).into[In3[Option1, Option2, Option3]].runOpt.runOpt.runOpt.run === 1

    // make sure that flatMap works
    Eff.send[Option1, In2[Option1, Option2], Int](Option1(1)).flatMap(i => Eff.send(Option2(i))).into[In3[Option1, Option2, Option3]].runOpt.runOpt.runOpt.run === 1
 }
